...
function change(){
  if(temp==0){
    ...
    m.style.backgroundColor="#3e3e4a"
    side_bar.style.backgroundColor="#3e3e4a"
    top_bar.style.backgroundColor="#3e3e4a"
    temp=1;
  }
  else if(temp==1){
    ch.innerHTML='<i class="fa-solid fa-moon"></i>';
    m.style.backgroundColor= "#32697f";
    side_bar.style.backgroundColor=" #05445e"
    top_bar.style.backgroundColor="#05445e"
    temp=0;
  }  
}
// ========================form validator=============================
